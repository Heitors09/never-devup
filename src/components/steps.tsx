import { ChevronRight, Keyboard, ListTodo, UserPen } from "lucide-react";

export const Steps = () => {
	return (
		<div
			id="processo"
			className="px-32 py-24 grid  lg:grid-cols-2 justify-center xl:flex gap-4 w-full "
		>
			...
			<div className="md:w-full lg:size-96 shadow-2xl rounded-[8px] hover:cursor-pointer hover:bg-white/10 duration-200 p-6 flex flex-col justify-center items-center gap-4">
			  <UserPen className="size-30 text-[#C7F900]"/>
			...
			<ListTodo className="size-30 text-[#C7F900]"/>
			...
			<Keyboard className="size-30 text-[#C7F900]"/>
